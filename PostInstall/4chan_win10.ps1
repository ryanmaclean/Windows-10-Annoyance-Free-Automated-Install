<#
    ...
    KNOWN ISSUES
        ° If another process is accessing your hosts file or your OneDrive folders, you will see error messages.
          ...
          not syncing files and folders with OneDrive and you don't have some weird virus.
#>
...
# ======================================================================================================= Main Code
Write-Host "YOUR COMPUTER IS BEING DEBLOATED. HOLD ON." -ForegroundColor Green
